 ...
 * 243 codes.
 */
export const ICD_SCHEME_CODES: readonly string[] = Object.freeze([
...
/** Membership lookup for {@link ICD_SCHEME_CODES}. */
export const ICD_SCHEME_CODES_SET: ReadonlySet<string> = new Set(ICD_SCHEME_CODES);
