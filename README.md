...
Invoices and credit notes in all of them. 289 rules of the regulation (EN 16931
...
- **Peppol BIS Billing 3.0** (only on `profile: "peppol-bis-3"`):
  ...
  identifier checksums `PEPPOL-COMMON-R040` .. `R047`, `R049`, `R050`,
  `R052`, `R053`.
